...
class VMParser:
    ...
    def is_command(self, line_arr):
        ...
        if self.is_arithmetic_command(line_arr):
            ...
            is_command = True
        elif self.is_label_command(line_arr):
            self.__command_type = VMParser.CommandTypes.LABEL
            is_command = True
        elif self.is_goto_command(line_arr):
            self.__command_type = VMParser.CommandTypes.GOTO
            is_command = True
        elif self.is_if_goto_command(line_arr):
            self.__command_type = VMParser.CommandTypes.IF_GOTO
            is_command = True
        elif self.is_call_command(line_arr):
            self.__command_type = VMParser.CommandTypes.CALL
            is_command = True
        elif self.is_function_command(line_arr):
            self.__command_type = VMParser.CommandTypes.FUNCTION
            is_command = True
        elif self.is_return_command(line_arr):
            self.__command_type = VMParser.CommandTypes.RETURN
            is_command = True
    ...
    @staticmethod
    def is_label_command(line_arr):
        """
        :return: True iff given array represents label program flow command
        """
        return line_arr[0] == "label"

    @staticmethod
    def is_goto_command(line_arr):
        """
        :return: True iff given array represents goto program flow command
        """
        return line_arr[0] == "goto"

    @staticmethod
    def is_if_goto_command(line_arr):
        """
        :return: True iff given array represents if-goto program flow command
        """
        return line_arr[0] == "if-goto"

    @staticmethod
    def is_call_command(line_arr):
        """
        :return: True iff given array represents call program control command
        """
        return line_arr[0] == "call"

    @staticmethod
    def is_function_command(line_arr):
        """
        :return: True iff given array represents function program control command
        """
        return line_arr[0] == "function"

    @staticmethod
    def is_return_command(line_arr):
        """
        :return: True iff given array represents return program control command
        """
        return line_arr[0] == "return"
    ...
    def arg1(self):
        ...
        """
        if self.__command_type == VMParser.CommandTypes.ARITHMETIC or \
                self.__command_type == VMParser.CommandTypes.RETURN:
